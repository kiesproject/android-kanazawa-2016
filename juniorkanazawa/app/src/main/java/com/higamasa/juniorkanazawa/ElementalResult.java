...
public class ElementalResult extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schoolButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent backButton = new Intent(ElementalResult.this,MainActivity.class);
        ...
        ageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent backButton = new Intent(ElementalResult.this,ElementalChoice.class);
                startActivity(backButton);
            }
        });
    }
